...
* [`src/create/website/styles.cljs`](src/create/website/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/create/website/`](src/create/website/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/create/website/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `create.website` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/create/website/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns create.website.example
  (:require [create.website.config :as config])
